...
#'
#' @return This function returns the global sampling error when using a stratified sampling design without replacement to estimate the total, given the sample size.
#' @export
#'
#' @examples et_sts(C = 0.95, n_real = c(57, 29, 29), sd_est = c(5, 15, 10), alloc = c(1/2, 1/4, 1/4), N = c(150, 40, 110), parameter = FALSE)


# Sample error function
et_sts <- function(C, n_real, sd_est, alloc = NULL, N, parameter = FALSE) {

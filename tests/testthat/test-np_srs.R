...
test_that("Parameter 'C' must be in the range 0 <= C <= 1", {
...
test_that("Parameter 'e' must be in the range 0 <= e <= 1", {
...
test_that("Parameter 'p_exp' must be in the range 0 <= p_exp <= 1", {
...
test_that("Parameter 'N' must be a positive integer or Inf", {
